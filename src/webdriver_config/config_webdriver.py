...
class ConfiguracionWebDriver:
    ...
    def inicializar_webdriver_firefox(self):
        ...
        perfil_firefox.set_preference("browser.download.dir", self.folder_de_descargas)
    ...
    def inicializar_webdriver_chrome(self):
        ...
        opciones_chrome.add_experimental_option('prefs', {'download.default_directory': self.folder_de_descargas})
